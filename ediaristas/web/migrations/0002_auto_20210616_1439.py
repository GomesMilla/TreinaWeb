# Generated by Django 3.0 on 2021-06-16 14:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='diarista',
            name='cep',
            field=models.CharField(max_length=8, verbose_name='CEP da sua localização '),
        ),
        migrations.AlterField(
            model_name='diarista',
            name='codigo_ibge',
            field=models.IntegerField(verbose_name='Código do IBGE '),
        ),
        migrations.AlterField(
            model_name='diarista',
            name='complemento',
        ...
        migrations.AlterField(
            model_name='diarista',
            name='foto_usuario',
            field=models.ImageField(upload_to='', verbose_name='Imagem de perfil '),
        ),
        migrations.AlterField(
            model_name='diarista',
            name='logradouro',
        ...
        migrations.AlterField(
            model_name='diarista',
            name='numero',
            field=models.IntegerField(verbose_name='Número da residencia '),
        ),
        migrations.AlterField(
            model_name='diarista',
            name='telefone',
